...
from models import Category, Coupon, Order, Product, Purchase, Sale, Supplier, User, db
from services.storage_service import StorageService
from utils import (allowed_file, get_chart_data, get_monthly_comparison,
...
def export_sales():
    ...
    from utils import generate_sales_csv, generate_sales_pdf
